...
<img src="7 多维随机变量.assets/image-20211022211641930.png" align="left" alt="image-20211022211641930" style="zoom:67%;" />
...
$\displaystyle f_Z(z)=\int_{-\infty}^{+\infty}\frac{1}{|x|}f(x,xz)dz$
